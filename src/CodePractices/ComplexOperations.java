...
Write a class with the name ComplexOperations. The class needs two fields (instance variables) with name real and imaginary of type double. It represents the Complex Number.
...
Method named add with one parameter of type ComplexOperations. It needs to add the ComplexOperations parameter to the corresponding instance variables.
...
Method named subtract with one parameter of type ComplexOperations. It needs to subtract the other parameter from this complex number.
 */
...
public class ComplexOperations {
    ...
    public void add(ComplexOperations other) {
    ...
    public void subtract(ComplexOperations other) {
